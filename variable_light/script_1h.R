...
ethogramPlot(asleep, dt[light_duration==1 & t > days(0) & t < days(8)], condition=sex, time_unit_conversion = hours, error_bar = 'sem') +  annotate("rect", xmin=c(0, 24, 48, 72, 96, 120, 144, 168), xmax=c(1, 25, 49, 73, 97, 121, 145, 169), ymin=0, ymax=Inf, alpha=0.2, fill="yellow") 
